...
@patch(
    "code.budget_max.helper.getMaxTransactionLimit", return_value=100
...
@patch("telebot.telebot")
@patch(
    "code.budget_max.helper.validate_entered_amount", return_value=50
)  # Replace with a valid amount
@patch(
    "code.budget_max.helper.read_json", return_value=EXAMPLE_USER_DATA
)  # Replace with your data
@patch(
    "code.budget_max.helper.write_json", return_value=True
)  # Replace with success value
def test_post_max_budget_with_valid_amount(
    mock_bot, mock_validate_amount, mock_read_json, mock_write_json
):
