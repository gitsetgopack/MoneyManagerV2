...
def test_validate_transaction_limit_within_limit(
    mock_is_limit_available, mock_get_max_limit
):
...
@patch("code.helper.isMaxTransactionLimitAvailable", return_value=True)
@patch("code.helper.getMaxTransactionLimit", return_value=100.0)
def test_validate_transaction_limit_exceeds_limit(
    mock_is_limit_available, mock_get_max_limit
):
